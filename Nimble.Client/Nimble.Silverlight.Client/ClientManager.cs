...
using Nimble.Silverlight.Client.Common;
using Nimble.Silverlight.Client.Multicurrency;
using Nimble.Silverlight.Client.Geolocation;
using Nimble.Silverlight.Client.Maintenance;
using Nimble.Silverlight.Client.Multilanguage;
using Nimble.Silverlight.Client.Owner;
using Nimble.Silverlight.Client.Security;

#endregion Using

namespace Nimble.Silverlight.Client
{
        ...
        public override void SetClientEndpoint<T, I>(T client, EndpointConfiguration endpointConfiguration)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    basicHttpBinding.TransferMode = (TransferMode)Enum.Parse(typeof(TransferMode), basicHttpBindingConfiguration.TransferMode, true);
                }
